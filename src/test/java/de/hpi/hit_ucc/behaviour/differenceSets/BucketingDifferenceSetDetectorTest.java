...
public class BucketingDifferenceSetDetectorTest {
	private BucketingDifferenceSetDetector differenceSetDetector;

	@BeforeMethod
	private void beforeMethod() {
		differenceSetDetector = new BucketingDifferenceSetDetector(5);
	}
